...
export default function HomePage({children}: {children: any}) {
  ...
  <div className="flex flex-col">
    ...
    <PageGrid>
        <PageLink href="dailynote/1" timenote="12/2024">
        <h4 className="my-0 truncate">Note 1</h4>
        </PageLink>
        <PageLink href="dailynote/2" timenote="12/2024">
        <h4 className="my-0 truncate">Note 2</h4>
        </PageLink>
    </PageGrid>
  </div>
</Layout>;
